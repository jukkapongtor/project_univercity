<?php
	...
	echo "<script>window.location='../#ajax/product_list.php?page=$_GET[page]&keywords=$_GET[keywords]&product_type=$_GET[product_type]&product_quality=$_GET[product_quality]'</script>";
?>