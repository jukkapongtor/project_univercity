<?php
	...
	if(empty($_POST['quality_name'])||empty($_POST['product_type'])){
		echo "<script>alert('กรุณากรอกข้อมูลให้ครบถ้วน');window.location='../#ajax/quality_add.php'</script>";
	}else{
		...
		echo "<script>alert('เพิ่มหมวดหมู่สินค้าเรียบร้อย');window.location='../#ajax/quality_add.php'</script>";
	}
