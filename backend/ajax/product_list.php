...
function delete_size_product(ele){
	...
	swal({
	  title: "ลบขนาดสินค้า",
	  text: "คุณต้องการลบขนาดของสินค้าเลยใช่ไหม",
	  type: "warning",
	  showCancelButton: true,
	  confirmButtonColor: "#DD6B55",
	...
	function(){
	  window.location = 'ajax/function_product.php?data=delete_size&size_id='+size_id+'&product_id='+product_id;
	});
}
/*
								    ...
								    echo "<tr>";
								      	...
								      	if($row_size>0){
								      		while(list($size_id,$size_name,$product_amount_keep,$product_amount_shop,$product_amount_web,$product_price_shop,$product_sprice_shop,$product_price_web,$product_sprice_web)=mysqli_fetch_row($query_size)){
												...
												echo "<div class='col-md-7' style='padding:2px;;margin-bottom:4px'><input type='text' class='form-control' name='product_price_web[]' value='$product_price_web' style='margin-top:-5px;'></div>";
												echo "<div class='col-md-4' style='padding:0;margin-bottom:4px'>ราคาในร้าน</div>";
												echo "<div class='col-md-7' style='padding:2px;margin-bottom:4px'><input type='text' class='form-control' name='product_price_shop[]' value='$product_price_shop' style='margin-top:-5px;'></div>";
												echo "</div>";
											}
								    ...
								    echo "<tr>";
								      	...
								      	echo "<td><div class='input_fields_wrap' >";	
												...
												while(list($size_id_edit,$size_name_edit)=mysqli_fetch_row($query_size_edit)){
											   	...
											   	echo "<div class='col-md-12' style='padding:0'>";
												echo "<div class='col-md-4' style='padding:0;margin-bottom:4px'>ราคาบนเว็บ</div>";
												echo "<div class='col-md-7' style='padding:2px;;margin-bottom:4px'><input type='text' class='form-control' name='product_price_web[]' style='margin-top:-5px;'></div>";
												echo "<div class='col-md-4' style='padding:0;margin-bottom:4px'>ราคาในร้าน</div>";
												echo "<div class='col-md-7' style='padding:2px;margin-bottom:4px'><input type='text' class='form-control' name='product_price_shop[]' style='margin-top:-5px;'></div>";
								      	echo "</div></td>";
								    echo "</tr>";
									}
								echo "</table>";
