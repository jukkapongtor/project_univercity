...
function list_product(){
	...
	while (list($product_id,$product_name,$product_price,$product_type,$product_image)=mysqli_fetch_row($query_product)) {
		echo "<div class='col-md-3' style='margin-top:20px'>";
			...
			echo "<center><a href='index.php?module=product&action=product_detail&product_id=$product_id'><img src='images/$folder/$product_image' width='100%' height='300'><p><font style='font-size:20px'>$product_name</font></p></a>";
			if($sellstatus==1){
