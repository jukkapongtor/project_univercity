<?php
    ...
    $query_user =mysqli_query($_SESSION['connect_db'],"SELECT passwd FROM users WHERE username='$_POST[username_forgot]' AND email='$_POST[email_forgot]'" )or die("ERROR forgot passwword line 6");
